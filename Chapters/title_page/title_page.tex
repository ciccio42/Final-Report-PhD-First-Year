\begin{titlepage}
    ...
    \HRule \\[0.8cm]
    { \huge \bfseries Second year report}\\[0.3cm] % Title of your document
    \HRule \\[1.5cm]
    ...
    {\large XXXVII cycle - Academic year 2022/2023}\\[1cm] % Date, change the \today to a set date if you want to be precise
